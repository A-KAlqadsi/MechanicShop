...
public class CachingBehaviorTests
{
    ...
    public async Task Handle_WhenNotCachedQuery_ShouldSkipCacheAndReturnResult()
    {
        ...
        // Act
        var result = await behavior.Handle(uncachedRequest, () => Task.FromResult("OK"), CancellationToken.None);
    ...
    public async Task Handle_WhenCachedQueryAndResultIsError_ShouldNotCacheResult()
    {
        ...
        // Act
        var result = await _sut.Handle(request, () => Task.FromResult(errorResult), CancellationToken.None);
